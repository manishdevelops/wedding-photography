            ...
            <div className="flex flex-col md:flex-row items-center mb-12">
                ...
                <div>
                    ...
                    <p className="text-lg mb-4" style={{ fontFamily: "'Dancing Script', cursive", color: '#6c757d' }}>
                        With over 10 years of experience in wedding photography, John Doe has a unique style that captures the essence of every moment. His background in fine arts and passion for storytelling make him the perfect choice for your special day.
                    </p>
                </div>
            </div>
            <div className="text-center mb-12">
                <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: "'Dancing Script', cursive", color: '#d63384' }}>Our Mission</h2>
                <p className="text-lg" style={{ fontFamily: "'Dancing Script', cursive", color: '#6c757d' }}>
                    We aim to capture the real emotion of your special day, creating timeless memories that you will cherish forever. Our team is dedicated to providing the highest quality service and ensuring that every moment is beautifully documented.
                </p>
            </div>
            <div className="text-center">
                <Link to="/contact-us" className="text-white shadow-lg bg-pink-500 hover:bg-pink-700 rounded-md px-4 py-2 text-lg font-bold" style={{ fontFamily: "'Dancing Script', cursive" }}>
                    Contact Us
                </Link>
            </div>
        </div>
